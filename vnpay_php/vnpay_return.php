...
<?php
    ...
    if ($_GET['vnp_ResponseCode'] === "00") {
        ...
        echo "<script>window.open('http://localhost/JewelryStore/cart.php','self')</script>";
    }
...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="http://localhost/JewelryStore/assets/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="http://localhost/JewelryStore/assets/jumbotron-narrow.css" rel="stylesheet">         
        <script src="http://localhost/JewelryStore/assets/jquery-1.11.3.min.js"></script>
    </head>
    <body>
        <?php
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <a style="font-size:24px" href="http://localhost/JewelryStore//customer/my_account.php?my_orders">Xem Lịch Sử Đơn Hàng Của Bạn</a>
                </div> 
            </div>
            <p>
                &nbsp;

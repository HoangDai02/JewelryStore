<?php
// Bắt đầu session và thiết lập thời gian sống cho cookie
session_set_cookie_params('86400');
session_start();

// Kết nối cơ sở dữ liệu và include các hàm cần thiết
...
// Thiết lập thời hạn thanh toán (ví dụ: 1 ngày)
        ...
        <div class="mainTable">
            ...
            <table>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                <td><img class="table__image" src="../admin/<?php echo $product_image_1; ?>" alt="<?php echo $product_title; ?>"></td>
                                ...
                                <td><span><?php echo $_SESSION['product_quantity']; ?></span></td>
                            </tr>
                    <?php
                        }
                    }
            ...
            <div class="table-responsive">
                <form action="http://localhost/jewelrystore/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
